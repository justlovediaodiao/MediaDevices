...
namespace MediaDevices.Internal
{
    internal class StreamWrapper : Stream
    {
        ...
        protected override void Dispose(bool disposing)
        {
            if (this.stream != null)
            {
                // Do not use Marshal.ReleaseComObject - it is incompatible with StrategyBasedComWrappers.
                // Let the GC release the COM reference via the ComWrappers release mechanism.
                this.stream = null;
            }
