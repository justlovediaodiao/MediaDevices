...
namespace MediaDevices.Internal
{
    ...
    {
#pragma warning disable CS0649 // Fields are assigned conditionally in COMTRACE builds
...
#pragma warning restore CS0649
        ...
        public static void WriteObject(IPortableDeviceValues values, [CallerMemberName] string callerName = "")
        {
            InternalWriteObject(values, callerName);
        }

        [Conditional("COMTRACE")]
        public static void WriteObject(IPortableDeviceProperties deviceProperties, string objectId, [CallerMemberName] string callerName = "")
        {
        ...
        [Conditional("COMTRACE")]
        private static void InternalWriteObject(IPortableDeviceValues values, string callerName)
        {
            string func = callerName;
        ...
        public static void WriteObject(IPortableDevicePropVariantCollection collection)
        {
            ...
            for (uint index = 0; index < num; index++)
            {
                ...
                {
                    collection.GetAt(index, out val.Value);
